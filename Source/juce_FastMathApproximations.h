...
struct FastMathApproximations
{
    ...
    */
	...
	/** Offers a custom alternative waveshapper function that produces harder
		clipping, but may be more distortion than fuzz effect-inducing.
	*/
	template <typename FloatType>
	static FloatType custom1(FloatType x) noexcept {

		return (x / (.5 + abs(x)));

	}

	/** Offers a custom alternative waveshapper function that produces borderline
		square waves and may qualify as fuzz effect-inducing.
	*/
	template <typename FloatType>
	static FloatType custom2(FloatType x) noexcept {

		return (x / (.15 + abs(x)));

	}

	/** Offers a custom alternative waveshapper function that produces more
		traditional square waves.
	*/
	template <typename FloatType>
	static FloatType custom3(FloatType x) noexcept {
