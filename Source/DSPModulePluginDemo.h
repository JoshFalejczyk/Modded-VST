            ...
            : inputGain (addToLayout (layout,
              ...
              distortionType (addToLayout (layout,
                                           std::make_unique<AudioParameterChoice> (ID::distortionType,
                                                                                   "Waveshaper",
                                                                                   StringArray { "std::tanh", "Approx. tanh", "Custom function 1", "Custom function 2", "Custom function 3" },
                                                                                   0))),
...
private:
    ...
    struct DistortionProcessor
    {
        ...
        std::array<dsp::WaveShaper<float>, 5> waveShapers { { { std::tanh },
                                                              { dsp::FastMathApproximations::tanh }, 
															  { dsp::FastMathApproximations::custom1 }, 
															  { dsp::FastMathApproximations::custom2 },
															  { dsp::FastMathApproximations::custom3 } } };
...
public:
    ...
    void paint (Graphics& g) override
    {
        ...
        g.drawFittedText ("JOSH'S MODDED DSP MODULE DEMO", rectTop.reduced (10, 0), Justification::centredLeft, 1);
